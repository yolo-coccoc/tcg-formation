...
if __name__ == '__main__':
    input_folder = '/N/scratch/tnn3/DATA/nasa-merra2/merra2_domain'  # Update with your actual path
    ...
    # Export to CSV
    output_path = '/N/slate/tnn3/DucHGA/TC-formation/Data/Merra/data_path_check.csv'
